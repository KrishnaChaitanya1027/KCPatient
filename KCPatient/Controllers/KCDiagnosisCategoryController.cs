...
{
    public class KCDiagnosisCategoryController : Controller
    {
        private readonly PatientContext _context;
        private readonly INotyfService _notyfService;

        public KCDiagnosisCategoryController(PatientContext context, INotyfService notyfService)
        {
            _context = context;
            _notyfService = notyfService;
        }

        // GET: KCDiagnosisCategory
        public async Task<IActionResult> Index()
        {
            return View(await _context.DiagnosisCategory.ToListAsync());
        }

        // GET: KCDiagnosisCategory/Details/5
        ...
        // GET: KCDiagnosisCategory/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: KCDiagnosisCategory/Create
        ...
        // GET: KCDiagnosisCategory/Edit/5
        ...
        // POST: KCDiagnosisCategory/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: KCDiagnosisCategory/Delete/5
        ...
        // POST: KCDiagnosisCategory/Delete/5
