...
namespace KCPatient.Controllers
{
    ...
    public class KCCountryController : Controller
    {
        private readonly PatientContext _context;
        private readonly INotyfService _notyfService;
        public KCCountryController(PatientContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        // GET: KCCountry/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: KCCountry/Create
